...
import { Brain, Database, FolderOpen, History, MessageSquare, ScrollText, Settings, Sparkles } from 'lucide-react'

type ViewType = 'chat' | 'memory' | 'history' | 'workspace' | 'rag' | 'logs' | 'settings'
